...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <img src="images/INSIGNIA.jpg" width="90" height="90" class="d-inline-block align-top" alt=""/>
          <h1><a href="index.php" id="titulo" style="color:white; text-decoration: none; margin:20px;">C.E.P. Cristo Redentor</a> </h1> 
    ...
    <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
      ...
      <li class="nav-item"><a class="nav-link" href="index.php?page=inicio"><i class="fa fa-user"></i> Nosotros</a></li>
        <li class="nav-item"><a class="nav-link" href="index.php?page=user-profile"><i class="fa fa-user"></i> Bienvenido/a <?php echo $showrow['name']; ?>!</a></li>
